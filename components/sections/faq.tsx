...
function OrnamentalDivider() {
  return (
    <div className="flex items-center justify-center gap-1.5">
      ...
      <span className="h-0.5 w-0.5 rounded-full sm:h-1 sm:w-1" style={{ backgroundColor: "color-mix(in srgb, #c5a059 62%, transparent)" }} aria-hidden />
      <span
                ...
                <div
                  ...
                  style={{
                    borderColor: isOpen
                      ...
                      : "color-mix(in srgb, #c5a059 42%, transparent)",
                    backgroundColor: isOpen
                      ? `color-mix(in srgb, ${reminderInk.gold} 10%, ${paperWash.cream})`
                      : paperWash.lift,
                    boxShadow: isOpen
                      ? `inset 3px 0 0 ${reminderInk.gold}`
                      : "0 8px 28px color-mix(in srgb, #093327 10%, transparent), inset 0 1px 0 color-mix(in srgb, #fdf8f2 70%, transparent)",
                  }}
                >
                  <button
                    type="button"
